        ...
        if (opModeIsActive()) {
            ...
            while (opModeIsActive()) {
                if (tfod != null) {
                    ...
                    //this.vuforia.getCamera().createCaptureRequest(1, new Size, 1);
                    //Vuforia.setFrameFormat();
                    ...
                    if (updatedRecognitions != null) {
                        ...
                        //try {
                        //    telemetry.log().add("Picture type = %d %d x %d",this.vuforia.getFrameQueue().take().getImage(0).getFormat(),this.vuforia.getFrameQueue().take().getImage(0).getWidth(),this.vuforia.getFrameQueue().take().getImage(0).getHeight());
